# Code by David GALLO, and Varesse TIATSE SOUOP,
# Karunashree NAGARAJ was in our group but unforttunately was not able to contribute working code that we could include.
...
if (interactive()) {
  ...
  server <- function(input, output) {
    ...
    # Because Karuna wasn't able to finish their PPP vs Exchange Rate graph, we have added this simple text to the output to show that we are able to compare
